...
{
    public const string MAVLINK_BUILD_DATE = "Wed Nov 06 2019";
    ...
    public static message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(227, "FISHFINDER", 91, 22, 22, typeof( mavlink_fishfinder_t )),
    ...
    public enum MAV_CMD: ushort
    {
        ...
        TAKEOFF=22, 
        ///<summary> Land at local position (local frame only) |Landing target number (if available)| et from desired landing position - computed magnitude from spherical coordinates: d = sqrt(x^2 + y^2 + z^2), which gives the maximum accepted distance between the desired landing position and the position where the vehicle is about to land| Landing descend rate| Desired yaw angle| Y-axis position| X-axis position| Z-axis / ground level position|  </summary>
        ...
        CONDITION_LAST=159, 
        ///<summary> Set system mode. |Mode| Custom mode - this is system specific, please refer to the individual autopilot specifications for details.| al autopilot specifications for details.| Empty| Empty| Empty| Empty|  </summary>
        ...
        ///<summary> Control digital camera. This is a fallback message for systems that have not yet implemented PARAM_EXT_XXX messages and camera definition files (see https://mavlink.io/en/services/camera_def.html ). |Session control e.g. show/hide lens| Zoom's absolute position| oom from the current position| Focus Locking, Unlocking or Re-locking| Shooting Command| Command Identity| Test shot identifier. If set to 1, image will only be captured, but not counted towards internal frame count.|  </summary>
        ...
        REQUEST_MESSAGE=512, 
        ///<summary> Request autopilot capabilities. The receiver should ACK the command and then emit its capabilities in an AUTOPILOT_VERSION message |est autopilot version| Reserved (all remaining params)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  </summary>
        ...
        ///<summary> User defined waypoint item. Ground Station will show the Vehicle as flying through this item. |User defined| User defined| User defined| User defined| Latitude unscaled| Longitude unscaled| L), in meters|  </summary>
        [Description("User defined waypoint item. Ground Station will show the Vehicle as flying through this item.")]
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=22)]
    ///<summary> FishFinder output </summary>
    public struct mavlink_fishfinder_t
    {
        public mavlink_fishfinder_t(float depth,float temperature,float large_fish_depth,float medium_fish_depth,float small_fish_depth,byte active,byte battery_level) 
        {
              this.depth = depth;
              this.temperature = temperature;
              this.large_fish_depth = large_fish_depth;
              this.medium_fish_depth = medium_fish_depth;
              this.small_fish_depth = small_fish_depth;
              this.active = active;
        ...
        [Description("Depth.")]
        public  float depth;
            /// <summary>Temperature.  [deg] </summary>
        [Units("[deg]")]
        [Description("Temperature.")]
        public  float temperature;
            /// <summary>Large fish depth.  [m] </summary>
        [Units("[m]")]
        [Description("Large fish depth.")]
        public  float large_fish_depth;
            /// <summary>Medium fish depth.  [m] </summary>
        [Units("[m]")]
        [Description("Medium fish depth.")]
        public  float medium_fish_depth;
            /// <summary>Small fish depth.  [m] </summary>
        [Units("[m]")]
        [Description("Small fish depth.")]
        public  float small_fish_depth;
            /// <summary>FishFinder active.   </summary>
        [Units("")]
        [Description("FishFinder active.")]
        public  byte active;
